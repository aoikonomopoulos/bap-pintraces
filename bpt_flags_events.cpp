...
flags_type init_flags() {
    static flag f[] = {
        flag(RFLAGS::ID, RD | WR),
        flag(RFLAGS::VIP, RD | WR),
        flag(RFLAGS::VIF, RD | WR),
        flag(RFLAGS::AC, RD | WR),
        flag(RFLAGS::VM, RD | WR),
        flag(RFLAGS::RF, RD | WR),
        flag(RFLAGS::NT, RD | WR),
        flag(RFLAGS::IOPL, RD | WR),
        flag(RFLAGS::OF, RD | WR),
        flag(RFLAGS::DF, RD | WR),
        flag(RFLAGS::IF, RD | WR),
        flag(RFLAGS::TF, RD | WR),
